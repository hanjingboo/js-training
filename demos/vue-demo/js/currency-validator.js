var currencyValidator={
	...
	parse:function (newString,oldNumber) {
		...
		var NotAValiDollarAmountWarning=function (value) {
			return new CurrencyWarning(newString+'is not a valid dollar amount.',value);
		};
		var AutomaticConversionWarning=function (value) {
			return new CurrencyWarning(newString+'was automatic converted to '+value,value);
		};
		...
		if (isNaN(newNumber)) {
			if(
				...
				return new NotAValiDollarAmountWarning(oldNumber);
			}
		}
		...
		if(newCurrencyNumber==newNumber){
			...
			return new NotAValiDollarAmountWarning(
